...
{
    // 完整性
    public class Integrity : ReactiveObject
    {
        ...
        public Integrity(Process processA, State stateA, Attribute attributeA, Process processB, State stateB, Attribute attributeB)
        {
