...
namespace sbid._V
{
    public class CodeRefine_SW_V : Window
    {
        public CodeRefine_SW_V()
        {
        ...
        // 程序精化
        public void CodeRefine()
        {
            // 这里拼上 "_" + 选中的编程语言类型 + "_" + 选中的代码执行平台
            string command_file = ResourceManager.CodeRefine_refine + "_" + language_ComboBox.SelectedItem + "_" + platform_ComboBox.SelectedItem;
